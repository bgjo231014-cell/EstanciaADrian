  ...
  <div class="row mb-3">
    <div class="col-md-6">
        <div class="input-group">
            <span class="input-group-text">Búsqueda por mes y año</span>
            <input 
              type="month" 
              id="searchInput" 
              class="form-control" 
              placeholder="Buscar por mes en ambas tablas..."
              min="2000-01"
              max="2100-12"
            >
        </div>
        <small class="form-text text-muted mt-1">
            La búsqueda se aplica automáticamente a ambas tablas.
        </small>
    </div>
  </div>
...
<?php endforeach; ?>
      ...
      <?php else: ?>
        <tr><td colspan="11" class="text-center">No hay registros de agua.</td></tr>
      <?php endif; ?>
    </tbody>
  </table>
...
<?php endforeach; ?>
      ...
      <?php else: ?>
        <tr><td colspan="10" class="text-center">No hay consumos registrados.</td></tr>
      <?php endif; ?>
    </tbody>
  </table>
