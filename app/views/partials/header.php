...
if (is_numeric($usuario_rol)) {
    $roles = [1 => 'Administrador', 2 => 'Personal', 3 => 'Invitado'];
...
<header class="cecam-header text-white">
    ...
    <div class="logo-text">
        ...
        <nav class="header-nav">
            <div class="nav-buttons">
                ...
                <?php if ($usuario_id): ?>
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <a href="#" class="btn btn-outline-light nav-btn disabled">Descargas</a>
        ...
        <div class="user-section">
            ...
            <?php else: ?>
                <a href="index.php?view=login" class="btn btn-outline-light nav-btn">Iniciar Sesión</a>
            <?php endif; ?>
        </div>
    </div>
</header>
